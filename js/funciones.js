...
export function listaPrestamos() {
    ...
    arrayPrestamos.forEach(elemeto => {
        let li = document.createElement('li');
        li.innerHTML = elemeto.id + elemeto.titulo + elemeto.autor ;
        ul.appendChild(li);
    });
    return ul;
...
export function listaSocios() {
    ...
    let ul = document.createElement('ul');
    arraySocios.forEach(elemeto => {
        let li = document.createElement('li');
        li.textContent = elemeto.idSocio + elemeto.nombre + elemeto.mail;
        ul.appendChild(li);
    });
    return ul;
}
